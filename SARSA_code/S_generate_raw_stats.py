...
directory_raw = os.path.join(parent_directory, 'SARSA_data', 'S_raw_data')
directory_save_raw_stat = os.path.join(parent_directory, 'SARSA_data', 'S_stats')
directory_average = os.path.join(parent_directory, 'SARSA_data', 'S_raw_avg')
file_raw_stats = os.path.join(directory_save_raw_stat, 'S_raw_stats_SF.csv')
file_updated_raw_stats = os.path.join(directory_save_raw_stat, 'S_raw_stats_updated_SF.csv')
file_consolidated = os.path.join(directory_save_raw_stat, 'S_consolidated_stats_SF.csv')

sum_col = 'Rewards'
mean_med_cols = ['Steps', 'Difference']  
output_file_name = 'S_raw_stats_SF.csv'
